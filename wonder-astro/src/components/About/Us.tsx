...
export default function Us() {
  return (
    <section className="m-5 flex flex-col justify-center items-center border-black max-w-screen-md bg-white border-2 border-b-4 border-r-4 p-1 rounded-lg ">
      ...
      <img src={group} className="w-3/4 object-cover rounded-lg border-1"></img>
      <p className="text-center text-black py-2">
        We are 4 young Indonesian engineers creating solutions to help visually impaired individuals. Through the use of assistive
